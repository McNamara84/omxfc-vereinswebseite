                        ...
                        <form wire:submit="submit" 
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isLoggedIn): ?>
                                <div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['vorname'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['nachname'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-600 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showEmailWarning): ?>
                                        <p class="text-blue-600 text-sm mt-2">Diese E-Mail ist registriert. <a href="<?php echo e(route('login')); ?>" class="underline">Jetzt einloggen!</a></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            <?php else: ?>
                                <div class="p-4 bg-green-100 dark:bg-green-900 rounded">
                                    <p class="text-sm"> Angemeldet als <strong><?php echo e($user->firstname); ?> <?php echo e($user->lastname); ?></strong></p>
...
<?php unset($__componentOriginal69d2e70dc7c24f88dbff28cbd067ee07); ?>
<?php endif; ?>
                                    <div x-data="{ showTshirtSize: <?php echo e($tshirt_bestellt ? 'true' : 'false'); ?> }">
                                        <label class="flex items-start gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-500 mt-1">25,00 € Spende<?php echo e(!$isLoggedIn ? ' (zusammen mit Teilnahme: 30,00 €)' : ''); ?></p>
                                            </div>
                                        </label>
                                        ...
                                        <div x-show="showTshirtSize" x-transition class="mt-3" wire:key="tshirt-size-dropdown">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['tshirt_groesse'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH C:\xampp\htdocs\omxfc-vereinswebseite\omxfc-vereinswebseite\resources\views/livewire/fantreffen-anmeldung.blade.php ENDPATH**/ ?>