    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <h1 class="text-2xl font-semibold text-[#8B0116] dark:text-[#FCA5A5] mb-6">
                Rezension zu „{{ $book->title }}“ bearbeiten (Nr. {{ $book->roman_number }})
            </h1>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('reviews.update', $review) }}" method="POST">
                    ...
                    <div class="flex items-center justify-between">
                        <a href="{{ route('reviews.show', $book) }}" class="text-gray-600 dark:text-gray-400 hover:underline">Abbrechen</a>
