        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-maddrax-black border border-maddrax-red shadow-xl sm:rounded-lg p-6">
                ...
                <form action="{{ route('todos.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="title"
                            class="block text-sm font-medium text-maddrax-sand mb-1">Titel</label>
                    ...
                    <div class="mb-4">
                        <label for="category_id"
                            class="block text-sm font-medium text-maddrax-sand mb-1">Kategorie</label>
                    ...
                    <div class="mb-4">
                        <label for="description"
                            class="block text-sm font-medium text-maddrax-sand mb-1">Beschreibung</label>
                        <textarea name="description" id="description" rows="4"
                            class="w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-[#8B0116] dark:focus:border-[#FF6B81] focus:ring focus:ring-[#8B0116] dark:focus:ring-[#FF6B81] focus:ring-opacity-50">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-6">
                        <label for="points"
                            class="block text-sm font-medium text-maddrax-sand mb-1">Baxx</label>
