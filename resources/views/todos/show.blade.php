            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl sm:rounded-lg p-6">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                    ...
                    <div class="mt-2 md:mt-0">
                        @if($todo->status === 'open')
                            <span class="px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-full text-sm">Offen</span>
                        @elseif($todo->status === 'assigned')
                            <span class="px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded-full text-sm">In Bearbeitung</span>
                        @elseif($todo->status === 'completed')
                            <span class="px-2 py-1 bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 rounded-full text-sm">Wartet auf Verifizierung</span>
                        @elseif($todo->status === 'verified')
                            <span class="px-2 py-1 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded-full text-sm">Verifiziert</span>
                        @endif
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-md">
                            <div class="mb-2">
                                ...
                                <span class="ml-2 text-gray-800 dark:text-gray-200 font-semibold">{{ $todo->points }}</span>
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <span class="ml-2 text-gray-800 dark:text-gray-200">{{ $todo->created_at->format('d.m.Y H:i') }}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-md">
                            ...
                            @if($todo->completed_at)
                                <div class="mb-2">
                                    ...
                                    <span class="ml-2 text-gray-800 dark:text-gray-200">{{ $todo->completed_at->format('d.m.Y H:i') }}</span>
                                </div>
                            @endif
                            ...
                            @if($todo->verified_by)
                                ...
                                <div class="mb-2">
                                    ...
                                    <span class="ml-2 text-gray-800 dark:text-gray-200">{{ $todo->verified_at->format('d.m.Y H:i') }}</span>
                                </div>
                            @endif
                        </div>
                    </div>
