...
<x-modal :id="$id" :maxWidth="$maxWidth" {{ $attributes }}>
    <div class="bg-maddrax-black border border-maddrax-red px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div class="sm:flex sm:items-start">
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ms-4 sm:text-start">
                <h3 class="text-lg font-medium text-maddrax-sand">
                    {{ $title }}
                </h3>
    ...
    <div class="flex flex-row justify-end px-6 py-4 bg-maddrax-dark border border-maddrax-red text-end">
        {{ $footer }}
    </div>
</x-modal>
