                    ...
                    <div class="p-6">
                        ...
                        <form wire:submit.prevent="submit" class="space-y-4">
                            ...
                            @if (!$tshirtDeadlinePassed)
                                <div class="border-t pt-4" wire:key="tshirt-section" x-data="{ tshirtChecked: @entangle('tshirt_bestellt').live }">
                                    <label class="flex items-start gap-2">
                                        <input type="checkbox" 
                                               x-model="tshirtChecked"
                                               wire:key="tshirt-checkbox" 
                                               class="w-5 h-5 mt-0.5"
                                               x-on:change="console.log('DEBUG: Checkbox changed, tshirtChecked =', tshirtChecked); console.log('DEBUG: Livewire should update now')">
                                        <div>
                                    ...
                                    <div class="text-xs text-red-500 mt-2">
                                        DEBUG (Backend): tshirt_bestellt = {{ $tshirt_bestellt ? 'true' : 'false' }} (type: {{ gettype($tshirt_bestellt) }})
                                        <br>
                                        DEBUG (Frontend): <span x-text="'tshirtChecked = ' + tshirtChecked"></span>
                                    </div>
