        ...
        <ul class="flex gap-2 lg:flex-col text-sm text-base-content" role="list">
            @foreach ($sections as $section)
                <li class="flex-shrink-0 lg:flex-shrink">
                    <a
                        href="#{{ $section['id'] }}"
                        class="flex flex-col gap-0.5 rounded-md px-3 py-2 transition-colors duration-150 text-base-content hover:bg-base-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary data-[active=true]:bg-primary/10 data-[active=true]:text-primary"
