<x-app-layout>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 bg-gray-100 dark:bg-gray-800">
        ...
        <section class="mb-6">
            ...
            <ul class="list-disc ml-6 mt-2">
                <li>Index bereinigt für noch bessere Suchergebnisse im Kompendium</li>
                <li>3. Zyklus (50-74) für Kompendium indexiert</li>
                <li>4. Zyklus (75-99) für Kompendium indexiert</li>
            </ul>
        </section>
        <section class="mb-6">
