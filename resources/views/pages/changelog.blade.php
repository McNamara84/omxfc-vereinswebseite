<x-app-layout>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 bg-maddrax-dark border border-maddrax-red">
        ...
        <section class="mb-6">
            ...
            <h3 class="text-l font-semibold mb-2">Änderungen:</h3>
            <ul class="list-disc ml-6 mt-2">
                <li>Fix: Profilseite bearbeiten</li>
                <li>Fix: Statistikseite lädt nicht</li>
            </ul>
        </section>
        <section class="mb-6">
            <h2 class="text-xl font-semibold mb-2">Version 1.0.3 (25.06.2025)</h2>
            <h3 class="text-l font-semibold mb-2">Änderungen:</h3>
            <ul class="list-disc ml-6 mt-2">
                <li>Fix: Falsch-positive Fehlermeldung beim Absenden des Mitgliedsantrags behoben</li>
            </ul>
        </section>
        <section class="mb-6">
        ...
        <section class="mb-6">
            ...
            <ul class="list-disc ml-6 mt-2">
                ...
                <li>Neue Seite Rezensionen im internen Mitgliederbereich hinzugefügt</li>
            </ul>
            <h3 class="text-l font-semibold mb-2">Änderungen:</h3>
            <ul class="list-disc ml-6 mt-2">
        ...
        <section class="mb-6">
            <h2 class="text-xl font-semibold mb-2">Version 0.6.0 (04.04.2025)</h2>
            <h3 class="text-l font-semibold mb-2">Features:</h3>
            <ul class="list-disc ml-6 mt-2">
                <li>Neue Seite Challenges im internen Mitgliederbereich implementiert</li>
                <li>Badges in Profilen eingefügt</li>
                <li>Neue Seite Meetings im internen Mitgliederbereich ergänzt (Danke Marcel!)</li>
            </ul>
            <h3 class="text-l font-semibold mb-2">Änderungen:</h3>
            <ul class="list-disc ml-6 mt-2">
        ...
        <section class="mb-6">
            ...
            <h3 class="text-l font-semibold mb-2">Features:</h3>
            <ul class="list-disc ml-6 mt-2">
                <li>Erstellung der Webseite</li>
                <li>Navigation erstellt</li>
                <li>Satzung hinzugefügt</li>
