    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="relative border-l-4 border-[#8B0116] dark:border-[#ff4b63] pl-8 space-y-8">
            ...
            <div class="relative">
                ...
                <p class="mt-2">Im Jugendhaus St. Hubertus in Aachen, findet der zweite Tag der MaddraxCon zum 25jährigen Jubiläum der Heftserie statt. Gleichzeitig erscheint der <a href="https://de.maddraxikon.com/index.php?title=Quelle:MX654" target="_blank" class="text-blue-600 hover:underline">Jubiläumsband 654 "Metamorphose"</a> von <a href="https://de.maddraxikon.com/index.php?title=Oliver_M%C3%BCller" target="_blank" class="text-blue-600 hover:underline">Oliver Müller</a>, dessen Handlung passend zur Con ebenfalls in Aachen (Aarachne) spielt. An der Con nehmen Chefredakteur Michael "Mad Mike" Schönenbröcher und die Autoren Sascha Vennemann, Michael Edelbrock und Oliver Müller teil. Zeitgleich mit der Premiere auf Youtube wird den Conbesuchern der Fanfilm "Der Kristall" der Kurzfilmschmiede gezeigt.</p>
