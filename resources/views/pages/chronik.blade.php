<x-app-layout title="Chronik – Offizieller MADDRAX Fanclub e. V." description="Die wichtigsten Meilensteine des Offiziellen MADDRAX Fanclub e. V. seit seiner Gründung.">
    <x-public-page>
        <h1 class="text-3xl font-bold text-primary mb-8">Chronik des Offiziellen MADDRAX Fanclub e. V.</h1>
        <div class="relative border-l-4 border-primary pl-8 space-y-8">
            ...
            <div class="relative">
                ...
                <p class="mt-2">Im Jugendhaus St. Hubertus in Aachen, findet der zweite Tag der MaddraxCon zum 25jährigen Jubiläum der Heftserie statt. Gleichzeitig erscheint der <a href="https://de.maddraxikon.com/index.php?title=Quelle:MX654" target="_blank" class="link link-primary">Jubiläumsband 654 "Metamorphose"</a> von <a href="https://de.maddraxikon.com/index.php?title=Oliver_M%C3%BCller" target="_blank" class="link link-primary">Oliver Müller</a>, dessen Handlung passend zur Con ebenfalls in Aachen (Aarachne) spielt. An der Con nehmen Chefredakteur Michael "Mad Mike" Schönenbröcher und die Autoren Sascha Vennemann, Michael Edelbrock und Oliver Müller teil. Zeitgleich mit der Premiere auf Youtube wird den Conbesuchern der erste <a href="https://youtu.be/KfEpStNLYuM?si=oqNu66wsEt_ZYfux" target="_blank" class="link link-primary">Maddrax-Film "Der Kristall"</a> der Kurzfilmschmiede gezeigt.</p>
