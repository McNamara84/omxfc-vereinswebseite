<x-app-layout>
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 bg-maddrax-dark border border-maddrax-red rounded-lg shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            {{-- Fotogalerie --}}
            <div class="md:col-span-2 bg-maddrax-black border border-maddrax-red rounded-lg shadow-md overflow-hidden">
            ...
            <div class="md:col-span-2 bg-maddrax-black border border-maddrax-red rounded-lg shadow-md p-6">
                ...
                <ul class="list-disc ml-5 text-maddrax-sand space-y-2">
            ...
            <div class="bg-maddrax-black border border-maddrax-red rounded-lg shadow-md p-6">
                ...
                <ul class="list-disc ml-5 text-maddrax-sand">
            ...
            {{-- Anzahl Mitglieder --}}
            <div class="bg-maddrax-black border border-maddrax-red rounded-lg shadow-md p-6 flex flex-col justify-center items-center">
                <h2 class="text-4xl font-bold text-[#8B0116] dark:text-[#ff4b63]">{{ $memberCount }}</h2>
                <span class="text-maddrax-sand">aktive Mitglieder</span>
            </div>
        </div>
    </div>
