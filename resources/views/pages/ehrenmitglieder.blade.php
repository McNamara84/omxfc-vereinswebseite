<x-app-layout>
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 bg-maddrax-dark border border-maddrax-red rounded-lg shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <!-- Edelbrock, Michael -->
            <div
                class="bg-maddrax-black border border-maddrax-red rounded-lg shadow-md overflow-hidden transition-transform hover:scale-105 flex flex-col">
                ...
                <div class="p-4 flex flex-col flex-1">
                    ...
                    <p class="text-maddrax-sand text-sm mb-3">
