@php
    ...
    $customOverlays = [
        ...
        ['id' => 'preview-kassenbuch-reject-request', 'label' => 'Kassenbuch Anfrage ablehnen', 'source' => 'resources/views/livewire/kassenbuch-index.blade.php', 'family' => 'Livewire Overlay', 'backdropClass' => 'bg-black/50'],
