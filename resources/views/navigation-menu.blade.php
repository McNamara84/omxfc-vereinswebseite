...
<x-nav sticky full-width class="shadow-sm">
    ...
    <x-slot:actions>
        {{-- Theme-Toggle --}}
        <x-theme-toggle darkTheme="coffee" lightTheme="caramellatte" darkClass="dark" lightClass="" />
...
{{-- Mobile-Menü --}}
<div id="mobile-navigation" x-show="open" x-cloak x-collapse class="lg:hidden bg-base-100 border-b border-base-content/10">
    <x-menu class="p-2">
        @auth
