<nav x-data="{ open: false, openMenu: null }" class="bg-maddrax-black border-b border-maddrax-red xl:fixed xl:top-0 xl:left-0 xl:right-0 xl:z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
                ...
                <div class="hidden sm:ml-10 sm:flex sm:space-x-8">
                    @auth
                        ...
                        <div class="relative flex items-center ml-4 group" x-data="{ open: false }" @click="open = !open" @click.away="open = false" @keydown.escape="open = false">
                            <button id="verein-button" type="button" class="px-3 py-2 text-sm font-medium text-maddrax-sand hover:text-maddrax-red focus:outline-none focus-visible:ring-2 focus-visible:ring-maddrax-red transition" :aria-expanded="open" aria-controls="verein-menu" @keydown.enter.prevent="open = !open" @keydown.space.prevent="open = !open">
                                Verein
                            </button>
                            <div id="verein-menu" x-show="open" x-cloak class="absolute left-0 top-full mt-px w-48 bg-maddrax-black border border-maddrax-red rounded-md shadow-lg z-50 py-2 group-hover:block" role="menu">
                        ...
                        <div class="relative flex items-center ml-4 group" x-data="{ open: false }" @click="open = !open" @click.away="open = false" @keydown.escape="open = false">
                            <button id="veranstaltungen-button" type="button" class="px-3 py-2 text-sm font-medium text-maddrax-sand hover:text-maddrax-red focus:outline-none focus-visible:ring-2 focus-visible:ring-maddrax-red transition" :aria-expanded="open" aria-controls="veranstaltungen-menu" @keydown.enter.prevent="open = !open" @keydown.space.prevent="open = !open">
                                Veranstaltungen
                            </button>
                            <div id="veranstaltungen-menu" x-show="open" x-cloak class="absolute left-0 top-full mt-px w-48 bg-maddrax-black border border-maddrax-red rounded-md shadow-lg z-50 py-2 group-hover:block" role="menu">
                                <x-dropdown-link href="{{ route('fotogalerie') }}">Fotos</x-dropdown-link>
                                <x-dropdown-link href="{{ route('meetings') }}">Meetings</x-dropdown-link>
                            </div>
                        </div>
                        <div class="relative flex items-center ml-4 group" x-data="{ open: false }" @click="open = !open" @click.away="open = false" @keydown.escape="open = false">
                            <button id="baxx-button" type="button" class="px-3 py-2 text-sm font-medium text-maddrax-sand hover:text-maddrax-red focus:outline-none focus-visible:ring-2 focus-visible:ring-maddrax-red transition" :aria-expanded="open" aria-controls="baxx-menu" @keydown.enter.prevent="open = !open" @keydown.space.prevent="open = !open">
                                Baxx
                            </button>
                            <div id="baxx-menu" x-show="open" x-cloak class="absolute left-0 top-full mt-px w-48 bg-maddrax-black border border-maddrax-red rounded-md shadow-lg z-50 py-2 group-hover:block" role="menu">
                        ...
                        <!-- Dropdown Veranstaltungen -->
                        <div class="relative flex items-center ml-4 group" x-data="{ open: false }" @click="open = !open" @click.away="open = false" @keydown.escape="open = false">
                            <button id="belohnungen-button" type="button" class="px-3 py-2 text-sm font-medium text-maddrax-sand hover:text-maddrax-red focus:outline-none focus-visible:ring-2 focus-visible:ring-maddrax-red transition" :aria-expanded="open" aria-controls="belohnungen-menu" @keydown.enter.prevent="open = !open" @keydown.space.prevent="open = !open">
                                Belohnungen
                            </button>
                            <div id="belohnungen-menu" x-show="open" x-cloak class="absolute left-0 top-full mt-px w-48 bg-maddrax-black border border-maddrax-red rounded-md shadow-lg z-50 py-2 group-hover:block" role="menu">
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = !open" class="inline-flex items-center justify-center p-2 rounded-md text-maddrax-sand hover:bg-maddrax-red">
    ...
    <div :class="{'block': open, 'hidden': !open}" class="hidden sm:hidden">
        @auth
            ...
            <button id="verein-mobile-button" type="button" @click="openMenu = (openMenu === 'verein' ? null : 'verein')" class="w-full text-left px-4 py-2 font-bold text-maddrax-sand focus:outline-none focus-visible:ring-2 focus-visible:ring-maddrax-red" :class="{ 'bg-maddrax-red': openMenu === 'verein' }" :aria-expanded="openMenu === 'verein'" aria-controls="verein-mobile-menu" @keydown.enter.prevent="openMenu = (openMenu === 'verein' ? null : 'verein')" @keydown.space.prevent="openMenu = (openMenu === 'verein' ? null : 'verein')">
            Verein</button>
            ...
            <button id="veranstaltungen-mobile-button" type="button" @click="openMenu = (openMenu === 'veranstaltungen' ? null : 'veranstaltungen')" class="w-full text-left px-4 py-2 font-bold text-maddrax-sand focus:outline-none focus-visible:ring-2 focus-visible:ring-maddrax-red" :class="{ 'bg-maddrax-red': openMenu === 'veranstaltungen' }" :aria-expanded="openMenu === 'veranstaltungen'" aria-controls="veranstaltungen-mobile-menu" @keydown.enter.prevent="openMenu = (openMenu === 'veranstaltungen' ? null : 'veranstaltungen')" @keydown.space.prevent="openMenu = (openMenu === 'veranstaltungen' ? null : 'veranstaltungen')">
            ...
            <button id="baxx-mobile-button" type="button" @click="openMenu = (openMenu === 'baxx' ? null : 'baxx')" class="w-full text-left px-4 py-2 font-bold text-maddrax-sand focus:outline-none focus-visible:ring-2 focus-visible:ring-maddrax-red" :class="{ 'bg-maddrax-red': openMenu === 'baxx' }" :aria-expanded="openMenu === 'baxx'" aria-controls="baxx-mobile-menu" @keydown.enter.prevent="openMenu = (openMenu === 'baxx' ? null : 'baxx')" @keydown.space.prevent="openMenu = (openMenu === 'baxx' ? null : 'baxx')">
            Baxx</button>
            ...
            <button id="belohnungen-mobile-button" type="button" @click="openMenu = (openMenu === 'belohnungen' ? null : 'belohnungen')" class="w-full text-left px-4 py-2 font-bold text-maddrax-sand focus:outline-none focus-visible:ring-2 focus-visible:ring-maddrax-red" :class="{ 'bg-maddrax-red': openMenu === 'belohnungen' }" :aria-expanded="openMenu === 'belohnungen'" aria-controls="belohnungen-mobile-menu" @keydown.enter.prevent="openMenu = (openMenu === 'belohnungen' ? null : 'belohnungen')" @keydown.space.prevent="openMenu = (openMenu === 'belohnungen' ? null : 'belohnungen')">
            Belohnungen</button>
