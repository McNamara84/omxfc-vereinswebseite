...
class AbenteurerHttpsFixtureStream
{
...
class CrawlAbenteurerCommandTest extends TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        stream_wrapper_register('https', AbenteurerHttpsFixtureStream::class);
    }
    ...
    protected function tearDown(): void
    {
        ...
        AbenteurerHttpsFixtureStream::$fixtures = [];
    ...
    {
        $pageOneUrl = 'https://de.maddraxikon.com/index.php?title=Kategorie:Die_Abenteurer-Heftromane';
        $pageTwoUrl = 'https://de.maddraxikon.com/index.php?title=Kategorie:Die_Abenteurer-Heftromane&pagefrom=2';
        $htmlPage1 = '<meta charset="UTF-8"><div id="mw-pages"><a href="wiki/A1">A1</a></div><a href="index.php?title=Kategorie:Die_Abenteurer-Heftromane&pagefrom=2">nächste Seite</a>';
...
HTML;
    ...
    public function test_write_heftromane_sorts_and_writes_json(): void
    {
        ...
        $file = storage_path('app/private/abenteurer.json');
