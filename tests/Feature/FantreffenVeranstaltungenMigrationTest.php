...
class FantreffenVeranstaltungenMigrationTest extends TestCase
{
    ...
    public function test_migration_up_handles_missing_legacy_email_unique_index(): void
    {
        $this->dropIndexIfExists('fantreffen_anmeldungen', 'fantreffen_anmeldungen_email_unique', true);
